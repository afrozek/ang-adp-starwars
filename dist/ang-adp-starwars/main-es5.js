...
var CharacterCardComponent = /** @class */ (function () {
    function CharacterCardComponent() {
    }
    CharacterCardComponent.prototype.ngOnInit = function () {
    };
...
var CharacterDetailComponent = /** @class */ (function () {
    function CharacterDetailComponent(charactersService, route) {
        var _this = this;
        ...
        this.characterMetaDetails = this.charactersService.getCharactersList().filter(function (item) { return item.id == _this.characterId; })[0];
    ...
    CharacterDetailComponent.prototype.fetchCharacterDetail = function (id) {
        var _this = this;
        this.charactersService.getCharacterDetail(id)
            .subscribe(function (detail) {
            // console.log(detail.films);
            _this.characterDetails = detail;
            _this.fetchCharacterMoviesDetails(detail.films);
        }, function (error) {
            _this.errorLoading = true;
            _this.errorLoadingText = "Failed to load character details";
            // alert(error);
            console.log(error);
        });
    };
    ...
    //   })
    // }
    CharacterDetailComponent.prototype.fetchCharacterMoviesDetails = function (films) {
        var _this = this;
        this.loadingText = "2 of 2: Loading Films Details";
        this.charactersService.getAllMoviesDetails(films)
            .subscribe(function (res) {
            console.log("res: ", res);
            _this.characterMoviesDetails = res;
            _this.loadedDetail = true;
        }, function (err) {
            _this.errorLoading = true;
            _this.errorLoadingText = "Failed to load films details";
        });
    };
    CharacterDetailComponent.ctorParameters = function () { return [
...
var CharacterFilmsComponent = /** @class */ (function () {
    function CharacterFilmsComponent() {
        this.selectedMovie = null;
    }
    CharacterFilmsComponent.prototype.selectedMovieHandler = function (movie) {
        this.selectedMovie = movie;
    };
    CharacterFilmsComponent.prototype.ngOnInit = function () {
    };
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()
    ...
    return CharacterFilmsComponent;
}());
...
var CharactersHomeComponent = /** @class */ (function () {
    ...
    CharactersHomeComponent.prototype.ngOnInit = function () {
        this.fetchCharacters();
    };
    CharactersHomeComponent.prototype.fetchCharacters = function () {
...
var CharactersService = /** @class */ (function () {
    ...
    CharactersService.prototype.getCharactersList = function () {
        return [
            {
                id: 1,
                name: "Luke Skywalker",
    ...
    CharactersService.prototype.getCharacterDetail = function (id) {
        return this.http.get("https://swapi.co/api/people/" + id + "/");
    };
    CharactersService.prototype.getAllMoviesDetails = function (films) {
        var _this = this;
        console.log(films);
        var filmsObservablesList = films.map(function (film) {
            return _this.http.get(film);
        });
